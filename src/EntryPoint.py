...
class Runtime:
    def __init__(self, model_path: str, use_gpu: bool = True):
        ...
        """
        self.ai = llm_interface(model_path, use_gpu)
        self.chat_app = ChatApp(model=self.ai.model, tokenizer=self.ai.tokenizer, device=self.ai.device, on_generate_function=self.ai.on_generate)
